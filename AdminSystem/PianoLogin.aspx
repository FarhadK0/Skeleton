<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PianoLogin.aspx.cs" Inherits="PianoLogin" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblPIanoLogin" runat="server" style="z-index: 1; left: 10px; top: 34px; position: absolute" Text="Piano Management Login Page"></asp:Label>
