...
<body>
    <form id="form1" runat="server">
        <asp:ListBox ID="lstPianoList" runat="server" style="z-index: 1; left: 9px; top: 47px; position: absolute; height: 434px; width: 549px"></asp:ListBox>
        <div>
        </div>
        ...
        <asp:Label ID="lblFilterBySerialNumber" runat="server" style="z-index: 1; left: 275px; top: 503px; position: absolute" Text="Enter a Model Name:"></asp:Label>
        <p>
            &nbsp;</p>
        ...
        <asp:TextBox ID="txtFilterByModelName" runat="server" style="z-index: 1; left: 431px; top: 499px; position: absolute; height: 22px"></asp:TextBox>
        ...
        <asp:Button ID="btnReturnToMainMenu" runat="server" OnClick="btnReturnToMainMenu_Click" style="z-index: 1; left: 13px; top: 633px; position: absolute" Text="Return To Main Menu" />
    </form>
</body>
</html>
