...
<body style="height: 376px">
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtDeliveryOptions" runat="server" style="z-index: 1; left: 88px; top: 132px; position: absolute" height="22px" width="128px"></asp:TextBox>
        ...
        <asp:TextBox ID="txtCustomerName" runat="server" style="z-index: 1; left: 88px; top: 83px; position: absolute; bottom: 528px" height="22px" width="128px"></asp:TextBox>
        <asp:TextBox ID="txtPurchaseId" runat="server" style="z-index: 1; left: 88px; top: 26px; position: absolute" height="22px" width="128px"></asp:TextBox>
        ...
        <asp:TextBox ID="txtProductPrice" runat="server" style="z-index: 1; left: 88px; top: 191px; position: absolute" height="22px" width="128px"></asp:TextBox>
        <asp:TextBox ID="txtQuantity" runat="server" style="z-index: 1; left: 88px; top: 239px; position: absolute" height="22px" width="128px"></asp:TextBox>
        ...
        <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" style="z-index: 1; left: 30px; top: 445px; position: absolute" Text="OK" />
        ...
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 21px; top: 401px; position: absolute"></asp:Label>
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 110px; top: 445px; position: absolute" Text="Cancel" />
        </div>
        <p>
            &nbsp;</p>
    </form>
